...
$.getJSON(`${baseURL}pokemon/248/`, function (data) {
...
// $.getJSON(`${baseURL}pokemon/${randomPokemonId1}/`, function (data) {
//      let pokemon1 = data.name;
//      console.log("Part 2:");
//      console.log(randomPokemonId1, pokemon1);
//      $.getJSON(`${baseURL}pokemon/${randomPokemonId2}/`, function (data) {
//           let pokemon2 = data.name;
//           console.log(randomPokemonId2, pokemon2);
//           $.getJSON(`${baseURL}pokemon/${randomPokemonId3}/`, function (data) {
...
$.getJSON(`${baseURL}pokemon/${randomPokemonId1}/`, function (data) {
     let pokemon1 = data.name;
     console.log("Part 3:");
     $.getJSON(`${baseURL}pokemon-species/${pokemon1}`, function (data) {
     ...
     $.getJSON(`${baseURL}pokemon/${randomPokemonId2}/`, function (data) {
          let pokemon2 = data.name;
          $.getJSON(`${baseURL}pokemon-species/${pokemon2}`, function (data) {
               ...
               $.getJSON(
                    `${baseURL}pokemon/${randomPokemonId3}/`,
                    function (data) {
                         let pokemon3 = data.name;
                         $.getJSON(
